function Juego(){
	...
	*/
	this.constructor=function(idCanvas){
		...
		var texto=document.getElementById('msj');
		...
		this.panel.style.fontFamily="fippsregular";
		this.panel.style.textTransform="uppercase";

		texto.appendChild(this.panel);
	...
	*/
	this.iniciarEntidades=function(){
		...
		this.nave.constructor(this,200,700);
		...
		for (var fila=0;fila<4;fila++)
		{
			for (var i=0;i<5;i++)
			{
				...
				alien.constructor(this,100+i*70,40+fila*90,fila);
	...
	*/
	this.notificarMuerte=function(){
		...
		if (this.vidas>0)
		{
			this.panel.innerHTML="Puedes volver a intentarlo o entrar a nuestra <a href='https://www.facebook.com/mangopixel' target='_blank'>Fan Page en Facebook</a> o presiona Enter Para volver a empezar";
		}
		else
		{
			this.panel.innerHTML="Te han eliminado completamente, reta a tus amigos a probar este juego en nuestra <a href='https://www.facebook.com/mangopixel' target='_blank'>Fan Page en Facebook</a> o presiona Enter Para volver a empezar";
		}
	...
	*/
	this.notificarVictoria=function(){
		this.panel.innerHTML="¡Felicidades! Lo has hecho muy bien, ahora invita a tus amigos a nuestra <a href='https://www.facebook.com/mangopixel' target='_blank'>Fan Page en Facebook</a> o presiona Enter Para volver a empezar";
		this.esperandoTecla=true;
	};
	...
	*/
	this.loop=function(){
		if (this.gameRunning)
		{
			...
			this.contexto.font = "bold 14px fippsregular";
			this.contexto.fillText("Puntos: "+this.puntuacion,290,60);
			this.contexto.fillText("Vidas: x"+this.vidas,this.canvas.width-156,30);
